...
import styles from './compositionDraftDetailsRubric.css';

class CompositionDraftDetailsRubric extends Component {
  state = {
...
CompositionDraftDetailsRubric.propTypes = {
  rubric: PropTypes.object
};

export default CompositionDraftDetailsRubric;
