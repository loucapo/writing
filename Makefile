...
clone-front-end:
	git clone git@bitbucket.org:mnv_tech/wk_frontend.git -b wk_dev --single-branch ../wk_frontend

clone-data:
	git clone git@bitbucket.org:mnv_tech/wk_data.git -b wk_dev --single-branch ../wk_data

clone-yo:
	git clone git@bitbucket.org:mnv_tech/wk_yo_generators.git -b wk_dev --single-branch ../wk_yo_generators
