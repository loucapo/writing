...
//                 expectedVersion: -2
//             };
//             (function(){mut('myTestStream',appendData)})
...
//             appendData.events = [new EventData( 'testing1', { data:'someData' },
// {eventTypeName:'testingEventNotificationOff'})];
