  ...
  criteria: [
    {
      ...
      draft_goals_1: 'dagobah mace ben calrissian dooku k-3po kamino. Mandalore chewbacca jade jar lando yoda lando.',
      draft_goals_2: 'a han luuke wedge calamari endor thrawn. Hutt moff lobot wedge mon darth',
      draft_goals_3: 'inks. Padmé jabba mon mace jango organa utapau anakin darth',
      draft_goals_4: 'enobi leia skywalker skywalker darth darth solo. Kamino padmé luke grievous jade ben hutt. Windu n',
      draft_goals_5: 's darth binks windu kessel r2-d2 ponda skywalker. Moff organa mustafar aayla ',
      draft_goals_6: 'olo jawa wicket darth ackbar binks jawa ben biggs. Aayla jinn organa qui-gon c',
...

    {
      ...
      draft_goals_1: 'ko mayagil ryn mon wicket maarek fel paploo',
      draft_goals_2: 'ando tono. Xappyh nelvaanian nien piett chadra-fan whitesun. Jerjerrod fode caamasi skywalker. Marek doldur palpatine organa. Illum aleena mantell ahsoka a',
      draft_goals_3: 'moff depa. Ubese jinn dantooine ka beru dug',
      draft_goals_4: 'needa frozian rom jerec porkins. Terentatek mothma drachnam asajj kal. Skywalker omwati whiphid twilek. Ansuroer sly reb',
      draft_goals_5: 'needa frozian rom jerec porkins. Terentatek mothma drachnam asajj kal. Skywalker omwati whi',
      draft_goals_6: 'lig. Vagaari freedon ackbar jax aka. Pol',
...

    {
      ...
      draft_goals_1: 'wicket maarek fel paploo falleen. Moff mustafar garm devaronian mon. Beru zuggs n',
      draft_goals_2: 'ako mayagil ryn mon wicket maarek f',
      draft_goals_3: 'ahsoka antilles yuuzhan quadrinaros r4-p17 mod. Thennqora darpa trio',
      draft_goals_4: 'ese jinn dantooine ka beru dug nelvaanian elomin. Darth calamari elomin derek falleen quadrinar',
      draft_goals_5: 'polis bespin thisspias boz darth talortai. Kiffar hutt x1 jeremoch cody. Darth whill yavin chagrian dantari leia corellia owen elom. Xappyh joruus gotal ahsoka ablajeck troig. Vagaari freedon ackbar jax aka. Polis arkanian chewbacca ruurian m',
      draft_goals_6: 'aleena mantell ahsoka antilles yuuzhan quadrinaros r4-p17 mod. Thennqora darpa trioculus z',
...

    {
      ...
      draft_goals_1: 'anx ka pellaeon bren subterrel. -1b dor fel carondian ric. Gev mirax jawa darth tapani. Duro quelli luuke togruta shistavanen rune.',
      draft_goals_2: 'rinaros lars epicanthix. Terrik polis bespin thisspias boz dart',
      draft_goals_3: 'Bibble ansion nunb keshiri jango. Charal drovian kyp ozzel freedon thisspiasi',
      draft_goals_4: 'issa keshiri owen. Yavin kwa abyssin tython airen trioculus ongree thakwaash gricho. ',
      draft_goals_5: 'Bibble ansion nunb keshiri jango. Charal drovian kyp ozzel freedon thisspi',
      draft_goals_6: 'lorine carlist kwa. Wuher shmi nas ubb. Sing logray ryn mustafar valorum lando. ',
...

    {
      ...
      draft_goals_1: 'ino moff. Padmé obi-wan ben boba hutt mandalore wampa yoda. Cade darth bo',
      draft_goals_2: 'walker. Kit r2-d2 solo organa darth skywalker.',
      draft_goals_3: 'go mace qui-gon padmé darth gonk. Hutt moff darth sebulba bothan. Han mustafar calamar',
      draft_goals_4: 'lorians bothan kit. Fett ewok solo kashyyyk darth alderaan fett. Amidala darth tusken raider fett ahsoka. Lobot ',
      draft_goals_5: 'lars yoda coruscant padmé moff kenobi mon vader. Darth windu dantooine wampa antilles g',
      draft_goals_6: 'ker dagobah wedge calamari jinn. Naboo luke dooku mustafar alderaan darth darth orga',
