    ...
    <section>
      <div className={draftItemCss.draftLeft}>
        ...
        <ul>
          ...
          <li><span className={draftItemCss.bold}>Research/Evidence:</span> Integration of Research, Counterarguments</li>
        </ul>
      ...
      <div className={draftItemCss.draftRight}>
        ...
        <textarea className={draftItemCss.instructions}></textarea>
      </div>
    </section>
