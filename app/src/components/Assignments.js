...
const Assignments = ({ assignments }) => (
    <div id="assignments">
        <h2>Assignments</h2>
        <table
            summary={(assignments && assignments[0].tableSummary)
            ? assignments[0].tableSummary
            : 'A list of upcoming course content and assignments'}
        >
            <caption>{(assignments && assignments[0].tableCaption)
                ? assignments[0].tableCaption
                : 'Chapter 1 Assignments'}</caption>
            <thead>
                <tr>
                    <th className="ath-upcoming">{(assignments && assignments[0].isUpcoming)
