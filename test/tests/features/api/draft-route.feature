...
@pending=broken
  ...
  Scenario: Receive a 200 status when PUT /activity/:activityId/draft/:draftId/goals with valid cookie and json
    Given I get an instructor cookie and receive status '200'
    Given I PUT '{"goals":["4a7e811e-076d-488b-a523-94169c971e6d","bd500741-01d1-4ddc-b08b-dea70d55995f"]}' into ':3000/activity/d3e3c2d5-cf43-4f63-924f-3ec7a125a334/draft/e8ce0d9c-9824-4028-b0d7-ecaabb0bcae5/goals' and receive status '200'

  Scenario: Receive a 200 status when PUT /activity/:activityId/draft/:draftId/goals with valid cookie and json and no goals
    Given I get an instructor cookie and receive status '200'
    Given I PUT '{"goals":[]}' into ':3000/activity/d3e3c2d5-cf43-4f63-924f-3ec7a125a334/draft/e8ce0d9c-9824-4028-b0d7-ecaabb0bcae5/goals' and receive status '200'
@pending=broken
...
@pending=broken
  ...
  Scenario: Receive a 500 status when PUT /activity/:activityId/draft/:draftId/goals with non-existant goal
    Given I get an instructor cookie and receive status '200'
    Given I PUT '{"goals":["4a7e811e-076d-488b-a523"]}' into ':3000/activity/d3e3c2d5-cf43-4f63-924f-3ec7a125a334/draft/e8ce0d9c-9824-4028-b0d7-ecaabb0bcae5/goals' and receive status '500'
  ...
  Scenario: Receive a 200 status when PUT /activity/:activityId/draft/:draftId/studentreflectionquestions with valid cookie and json
    Given I get an instructor cookie and receive status '200'
    Given I PUT '{"studentReflectionQuestions":["823955a1-0a8e-42cc-b24c-cb30afcac93f","c105736c-c330-487c-be74-5a2c983095cc"]}' into ':3000/activity/d3e3c2d5-cf43-4f63-924f-3ec7a125a334/draft/e8ce0d9c-9824-4028-b0d7-ecaabb0bcae5/studentreflectionquestions' and receive status '200'
  ...
  Scenario: Receive a 200 status when PUT /activity/:activityId/draft/:draftId/studentreflectionquestions with valid cookie and json and no goals
    Given I get an instructor cookie and receive status '200'
    Given I PUT '{"studentReflectionQuestions":[]}' into ':3000/activity/d3e3c2d5-cf43-4f63-924f-3ec7a125a334/draft/e8ce0d9c-9824-4028-b0d7-ecaabb0bcae5/studentreflectionquestions' and receive status '200'
  @pending=broken
      # Getting a 200 here right now, don't think this should be allowed as UniqueItems=true
  Scenario: Receive a 500 status when PUT /activity/:activityId/draft/:draftId/studentreflectionquestions with duplicate goals
    Given I get an instructor cookie and receive status '200'
    Given I PUT '{"studentReflectionQuestions":["823955a1-0a8e-42cc-b24c-cb30afcac93f","823955a1-0a8e-42cc-b24c-cb30afcac93f"]}' into ':3000/activity/d3e3c2d5-cf43-4f63-924f-3ec7a125a334/draft/e8ce0d9c-9824-4028-b0d7-ecaabb0bcae5/studentreflectionquestions' and receive status '500'
  ...
  Scenario: Receive a 500 status when PUT /activity/:activityId/draft/:draftId/studentreflectionquestions with non-existant goal
    Given I get an instructor cookie and receive status '200'
    Given I PUT '{"studentReflectionQuestions":["4a7e811e-076d-488b-a523"]}' into ':3000/activity/d3e3c2d5-cf43-4f63-924f-3ec7a125a334/draft/e8ce0d9c-9824-4028-b0d7-ecaabb0bcae5/studentreflectionquestions' and receive status '500'
