...
@pending
  ...
  Scenario: Receive a 422 status when PUT /activity prompt with extra params
    Given I get an instructor cookie and receive status '200'
    Given I PUT '{"id": "d3e3c2d5--11-cf43-4f63-924f-3ec7a125a334","prompt":{"killme":"world"}}' into ':3000/activity/d3e3c2d5--11-cf43-4f63-924f-3ec7a125a334/prompt' and receive status '422'
  ...
  Scenario: Receive a 422 status when PUT /activity/:activityid/title with valid cookie and json but title greater than 140 characters
    Given I get an instructor cookie and receive status '200'
    Given I PUT '{"title": "This should be somewhere close to 140 characters of various sorts. I don't know why any instructor would want an assignment title this long. This is really absurd"}' into ':3000/activity/d3e3c2d5-cf43-4f63-924f-3ec7a125a334/title' and receive status '422'
  ...
  Scenario: Receive a 404 status when PUT /activity/:activityid/title with valid cookie and valid json with incomplete path
    Given I get an instructor cookie and receive status '200'
    Given I PUT '{"title": "222"}' into ':3000/activity/d3e3c2d5-cf43-4f63-924f-3ec7a125a334/' and receive status '404'