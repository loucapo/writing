...
exports.define = function(steps) {
  ...
  // "prompt","rubric_id","created_by","created_at","modified_by","modified_at")
  ...
  // "index", "created_by","created_at", "modified_by")
  ...
  // RETURNING "draft_id", "activity_id", "instructions", "index", "created_by", "created_at",
  // "modified_by", "modified_at";
  //
  // INSERT INTO "writer_key"."student_activity"("student_activity_id", "activity_id", "student_id",
  // "created_by", "created_at") VALUES('f0d2123e-2e10-4138-8af8-f93499eb02f0',
  ...
  // "student_id", "created_by", "created_at", "modified_by", "modified_at";
  //
  // INSERT INTO "writer_key"."student_draft"("student_draft_id", "student_activity_id",
  // "draft_id", "created_by", "created_at", "active", "submitted") VALUES('b9c60aa4-476a-4eae-9bc0-e8f026ef3ea2',
  ...
  // "created_by", "created_at", "modified_by", "modified_at", "active", "submitted";
