...
ALTER TABLE access_codes
    ADD COLUMN `batch_id` INT NOT NULL COMMENT '' AFTER `parent_id`;
...
ALTER TABLE access_codes
  ADD INDEX `batch_indx_idx` (`batch_id` ASC);
ALTER TABLE access_codes
  ADD CONSTRAINT `batch_indx`
...
ALTER TABLE batches
  ADD COLUMN business_unit INT NOT NULL AFTER `creator`;

ALTER TABLE batches
  ADD INDEX `business_unit_idx` (`business_unit` ASC);
ALTER TABLE batches
...
ALTER TABLE access_codes
  DROP FOREIGN KEY `batch_indx`;
ALTER TABLE access_codes
  CHANGE COLUMN `batch_id` `batch_id` INT(11) NULL;
ALTER TABLE access_codes
  ADD CONSTRAINT `batch_indx`
  FOREIGN KEY (`batch_id`)
  REFERENCES batches (`id`)
...
ALTER TABLE access_codes
  DROP FOREIGN KEY `batch_indx`;
  ALTER TABLE access_codes
  DROP INDEX `batch_indx_idx` ;

ALTER TABLE batches
  DROP FOREIGN KEY `business_unit`;
