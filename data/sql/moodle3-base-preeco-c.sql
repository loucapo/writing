...
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COMMENT='This table stores block instances. The type of block this is';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `mdl_block_positions` VALUES (1,21,1,'user-profile','1',1,'side-pre',2);
...
INSERT INTO `mdl_cache_flags` VALUES (1,'userpreferenceschanged','2',1463166126,'1',1463173326);
...
INSERT INTO `mdl_context` VALUES (1,10,0,'/1',1),(3,50,1,'/1/3',2),(4,40,1,'/1/4',2),(5,30,1,'/1/5',2),(6,30,2,'/1/6',2),(7,80,1,'/1/3/7',3),(8,80,2,'/1/3/8',3),(9,80,3,'/1/3/9',3),(10,80,4,'/1/10',2),(11,80,5,'/1/11',2),(12,80,6,'/1/12',2),(13,80,7,'/1/13',2),(14,80,8,'/1/14',2),(15,80,9,'/1/15',2),(16,80,10,'/1/16',2),(17,80,11,'/1/17',2),(18,80,12,'/1/18',2),(19,80,13,'/1/6/19',3),(20,80,14,'/1/6/20',3),(21,80,15,'/1/6/21',3),(22,80,16,'/1/6/22',3),(23,80,17,'/1/6/23',3),(24,80,18,'/1/6/24',3),(25,80,19,'/1/6/25',3),(26,80,20,'/1/26',2),(27,80,21,'/1/27',2);
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='Extra user pages for the My Moodle system';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `mdl_sessions` VALUES (3,0,'1kcr2sher0ermhbg62o47mjlk5',2,NULL,1463000633,1463001196,'172.20.0.1','172.20.0.1'),(5,0,'jimrrrqs1383gdvocab739b4a6',2,NULL,1463005206,1463005213,'172.20.0.1','172.20.0.1'),(7,0,'pjmcsnsiv4vi0hls4lk1ce3pp6',2,NULL,1463166126,1463166157,'172.20.0.1','172.20.0.1');
...
-- Dump completed on 2016-05-13 12:03:23
