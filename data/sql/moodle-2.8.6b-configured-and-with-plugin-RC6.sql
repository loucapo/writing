...
INSERT INTO `mdl_cache_flags` VALUES (1,'userpreferenceschanged','2',1444235115,'1',1444242315);
...
) ENGINE=InnoDB AUTO_INCREMENT=998 DEFAULT CHARSET=utf8 COMMENT='Changes done in server configuration through admin UI';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `mdl_sessions` VALUES (2,0,'8rvrhd11283vlcughnvklhmu27',2,NULL,1443937018,1443939418,'172.20.0.1','172.20.0.1'),(4,0,'l0m5rcreitvf13i90jetbs2fl7',2,NULL,1444235115,1444235893,'172.20.0.1','172.20.0.1');
...
-- Dump completed on 2015-10-07 11:47:05
