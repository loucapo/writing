    ...
    return {
      ...
      criteria: [
...

        {
          ...
          goal_option_1: `wicket maarek fel paploo falleen. Moff mustafar garm deletonian mon. Beru zuggs n`,
...

        {
          ...
          rubric_level_3: `Does not describe the problem in enough detail:: readers do not see a compelling need for
           action`,
...

        {
          ...
          goal_option_1: `dagobah mace ben calrissian dookuk-3pokamino. Mandalore chewbacca jade jar lando yoda lando.`,
          goal_option_2: `a han luuke wedge calamari endor thrawn. Hutt moff lobot wedge mon darth`,
          goal_option_3: `inks. Padmé jabba mon mace jango organa utapau anakin darth`,
